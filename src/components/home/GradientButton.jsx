...
/**
 * Naya Gradient Button (FotoFix Homepage ke liye)
 * Props:
 * - text: Button par kya likha hai
 * - icon: Button ke andar icon
 * - isBlue: Kya yeh "Discover" wala blue button hai
 * - isOutline: Kya yeh "Create" wala outline button hai
 */
export default function GradientButton({ text, icon, isBlue = false, isOutline = false }) {
  // Alag-alag button styles
